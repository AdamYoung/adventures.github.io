...
<template>
  ...
  <path
    ...
    <div class="flyout-menu" ref="flyoutMenu">
...
const toggleMenu = () => {
  ...
  if (isMenuOpen.value) {
    gsap.to('.flyout-menu', { x: '0%', duration: 0.5, ease: 'power2.out' })
    document.querySelector('.ham').classList.add('active')
  } else {
    gsap.to('.flyout-menu', { x: '100%', duration: 0.5, ease: 'power2.in' })
